...
Atomic transactions utilize Shared Memory (documented [here](https://github.com/f01c5700/avalanchego/blob/master/chains/atomic/README.md)) to send assets to the P-Chain and X-Chain.
